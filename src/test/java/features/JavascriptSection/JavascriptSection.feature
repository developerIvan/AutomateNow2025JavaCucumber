Feature: Javascript section page
  ...
  Scenario: User is able to access to the javascript page
    ...
    And the user waits for text "Welcome to your software automation practice website!" to be visible in Javascript section
    When the user clicks on the button "JavaScript Delays" in practice section
    And the user waits for text "There will be times when you will need to wait for certain conditions or events as you write automated tests." to be visible in Javascript section
